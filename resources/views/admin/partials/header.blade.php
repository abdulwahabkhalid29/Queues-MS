<header class="header">
    <div class="logo-container">
        <a href="https://www.okler.net/previews/porto-admin/4.2.0" class="logo">
            <img src="{{asset('')}}" width="130" height="45" alt="Porto Admin" />
        </a>
    ...
    <div class="header-right">
        ...
        {{-- <form action="https://www.okler.net/previews/porto-admin/4.2.0/pages-search-results.html" class="search nav-form">
        ...
        <div id="userbox" class="userbox">
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled mb-2">
                    ...
                    <li>
                        Logout
                        {{-- <a role="menuitem" onclick="$('#logout-form').submit();" tabindex="-1" href="javascript:;"><i class="bx bx-power-off"></i> Logout</a> --}}
